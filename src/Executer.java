...
public class Executer {
	...
	public static void main(String[] args) {
	  ...
	  {  
		  ...
		  else System.out.println("Tour de Blanc  --->");
		  ...
		  switch(i)
		  {
		  	case 1:		
		  				while(k<0||k>7)
					  	{
					  		System.out.print("saisissez la valeur de x  <valeur  entre 0 et 7>:");
					  		k=sc.nextInt();
					  	}
					  	while(l<0||l>7)
					  	{
					  		System.out.print("saisissez la valeur de y  <valeur  entre 0 et 7>:");
					  		l=sc.nextInt();
					  	}
					  	if(joueur)
					  		{
					  	...
					  	k=-1;l=-1;
					  	break;
		  	case 2: System.out.println("le compte est ");
		  			break;
		  	case 3: if(joueur)
		  		     System.out.println("Noir a gagné");
		  			else System.out.println("Blanc a gagné");
		  			System.exit(0);
		  }
	  }
	}
